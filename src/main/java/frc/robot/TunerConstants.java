...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.0).withKI(0).withKD(0.0).withKS(0.15070).withKV(0.78178);
  // new Slot0Configs().withKP(0.1).withKI(0).withKD(0.0).withKS(0.15070).withKV(0.78178); // kS =
  // 0, kV = 0.124
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.8); // 4.73
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.03173828125);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.18505859375);
