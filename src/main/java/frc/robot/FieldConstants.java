...
public class FieldConstants {
  ...
  public static class LinesVertical {
    ...
    public static final double starting = aprilLayout.getTagPose(26).get().getX();
    public static final double allianceZone = starting;
    public static final double hubCenter =
        aprilLayout.getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter =
        aprilLayout.getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone = aprilLayout.getTagPose(10).get().getX();
  }
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, aprilLayout.getTagPose(31).get().getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (aprilLayout.getTagPose(31).get().getY())
                + innerOpeningWidth / 2
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(fieldLength - frontFaceX, aprilLayout.getTagPose(15).get().getY());
    public static final Translation2d oppLeftUpright =
        new Translation2d(
            fieldLength - frontFaceX,
            (aprilLayout.getTagPose(15).get().getY())
                + innerOpeningWidth / 2
                + Units.inchesToMeters(0.75));
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, aprilLayout.getTagPose(29).get().getY());
  }
}
